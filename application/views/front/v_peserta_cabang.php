...
<ul class="nav justify-content-center nav-tabs">
   ...
   <li class="nav-item">
      <a class="nav-link active v-peserta-cabang">
...
<div id="peserta" class="pencarian">
   <?php foreach ($delegasis as $delegasi) : ?>
      <div class="my-3 p-3 bg-white rounded shadow">
         <h6 class="border-bottom border-dark pb-2 mb-0"><?= $delegasi->nama_cab ?></h6>
         <?php
         $asals = $this->peserta_model->get_join_cabang($delegasi->nama_cab);
...
<script>
   ...
   $(document).ready(function() {
      $('#btn-load-cabang').click(function(e) {
         ...
         $.ajax({
            type: "GET",
            url: "<?= site_url('welcome/load_cabang/') ?>" + posisi,
            beforeSend: function() {
